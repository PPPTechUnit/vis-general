! function(n) {
    ...
    var e = function() {
            ...
            function c(e, t) {
                var n, i, r, o, s, a, l, c, u, d, p, h = t && t.split("http://demo.interface.club/"),
                    f = y.map,
                    g = f && f["*"] || {};
                if (e) {
                    for (s = (e = e.split("http://demo.interface.club/")).length - 1, y.nodeIdCompat && w.test(e[s]) && (e[s] = e[s].replace(w, "")), "." === e[0].charAt(0) && h && (e = h.slice(0, h.length - 1).concat(e)), u = 0; u < e.length; u++)
                        if ("." === (p = e[u])) e.splice(u, 1), u -= 1;
                        else if (".." === p) {
                            if (0 === u || 1 === u && ".." === e[2] || ".." === e[u - 1]) continue;
                            0 < u && (e.splice(u - 1, 2), u -= 2)
                        }
                    e = e.join("http://demo.interface.club/")
                }
                if ((h || g) && f) {
                    for (u = (n = e.split("http://demo.interface.club/")).length; 0 < u; u -= 1) {
                        if (i = n.slice(0, u).join("http://demo.interface.club/"), h)
                            for (d = h.length; 0 < d; d -= 1)
                                if (r = (r = f[h.slice(0, d).join("http://demo.interface.club/")]) && r[i]) {
                                    o = r, a = u;
                                    break
                                } if (o) break;
                        !l && g && g[i] && (l = g[i], c = u)
                    }!o && l && (o = l, a = c), o && (n.splice(0, a, o), e = n.join("http://demo.interface.club/"))
                }
                return e
            }
