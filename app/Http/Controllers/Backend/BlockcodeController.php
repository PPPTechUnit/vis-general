...
class BlockcodeController extends Controller
{
    ...
    public function index(){
        ...
        return view('backend.block_codes.listing',['users'=>$users]);
    }
    ...
    public function create(){
        $users =  DB::table("users")->where('role_id',2)->where('status',1)->where('verified',1)->get()->toArray();
        $provinces =  DB::connection('mysql2')->table("provinces")->get()->toArray();
    return view('backend.block_codes.create',['provinces'=>$provinces,'users'=>$users]);
    }
     ...
     //  $blockes = DB::connection('mysql2')->table('voter_list_blockcode_info')->where('taluka_id',$user_block['tehsil_id'])->get()->toArray();
       ...
       $blockes = DB::connection('mysql2')->table('voter_list_voters_info')->where('added_by',$user_block['user_id'])->groupBy('blockcode')->orderBy('id',"DESC")->get()->toArray();
        ...
        $block_voters =array();
          ...
          return view('backend.block_codes.listing_record',['blockcodes'=>$block_voters]);
    }
    ...
    public function edit($id){
        ...
        return view('backend.block_codes.edit',$data);
    }
    ...
    public function viewBlockCodeRecord($blockcode){
        ...
        return view('backend.block_codes.voters_record',$block_voters);
    }
    ...
    public function editBlockCodeRecord($blockcode){
        ...
        return view('backend.block_codes.edit_electoral',$block_voters);
    }
