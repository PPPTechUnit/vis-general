...
@section('title', 'Blockcode Information  Edit Page')

@section('content')
    <section style="padding: 40px 10px; background: #fff">
        <h4 class="p-l-20">Edit Blockcode Information</h4>
        <hr>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="blockcodeForm" action="{{ route('blockcode-information.update', $blockcodes->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('blockcode') is-invalid @enderror" name="blockcode" value="{{ old('blockcode', $blockcodes->blockcode) }}" required>
                                        @error('blockcode')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>


                                    <!-- Electoral Area -->
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Electoral Area Name <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control @error('eloctoral_area_name') is-invalid @enderror" name="eloctoral_area_name" value="{{ old('eloctoral_area_name', $blockcodes->eloctoral_area_name) }}" required>
                                        @error('eloctoral_area_name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>

                                    <!-- Village City -->
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Village City <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control @error('village_city') is-invalid @enderror" name="village_city" value="{{ old('village_city', $blockcodes->village_city) }}" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('circle_name') is-invalid @enderror" name="circle_name" value="{{ old('circle_name', $blockcodes->circle_name) }}" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('committee') is-invalid @enderror" name="committee" value="{{ old('committee', $blockcodes->committee) }}" >
                                    ...
                                    <!-- Provincial Assembly -->
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Select Constituency <span class="text-danger">*</span></label>
                                        <select class="form-control @error('provincial_constituency_name') is-invalid @enderror" name="provincial_constituency_name" required>
                                            <option value="">Select</option>
                                            @foreach($nas as $na)
                                                <option value="{{ $na->id }}"
                                                        {{ old('provincial_constituency_name', $blockcodes->provincial_assembly_id) == $na->id ? 'selected' : '' }}>
                                                    {{ $na->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('provincial_constituency_name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>
                                        ...
                                        <select class="form-control @error('division_name') is-invalid @enderror" id="division_name" name="division_name" required>
                                            ...
                                            @foreach($divisions as $division)
                                                <option value="{{ $division->id }}"
                                                        {{ old('division_name', $blockcodes->division_id) == $division->id ? 'selected' : '' }}>
                                                    {{ $division->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <select class="form-control @error('district_name') is-invalid @enderror" id="district_name" name="district_name" required>
                                            ...
                                            @foreach($districts as $district)
                                                <option value="{{ $district->id }}"
                                                        {{ old('district_name', $blockcodes->district_id) == $district->id ? 'selected' : '' }}>
                                                    {{ $district->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <!-- Tehsil -->
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Tehsil <span class="text-danger">*</span>
                                            <span> <button type="button" class="btn btn-link btn-sm" onclick="addTehsil()">➕ Add Tehsil</button></span>
                                        </label>
                                        <select class="form-control @error('taluka_name') is-invalid @enderror" id="taluka_name" name="taluka_name" required>
                                            <option value="">Select Tehsil</option>
                                            @foreach($tehsils as $tehsil)
                                                <option value="{{ $tehsil->id }}"
                                                        {{ old('taluka_name', $blockcodes->taluka_id) == $tehsil->id ? 'selected' : '' }}>
                                                    {{ $tehsil->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('book_number') is-invalid @enderror" name="book_number" value="{{ old('book_number', $blockcodes->book_number) }}" >
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('pages') is-invalid @enderror" name="pages" value="{{ old('pages', $blockcodes->pages) }}" >
                                        @error('pages')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>

                                    <!-- Missing Pages -->
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label">Missing Pages</label>
                                        <input type="number" class="form-control @error('missing_page') is-invalid @enderror" name="missing_page" value="{{ old('missing_page', $blockcodes->missing_page) }}">
                                        @error('missing_page')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-control @error('condition') is-invalid @enderror" id="condition" name="condition" required>
                                            <option value="" {{ $blockcodes->condition == '' ? 'selected' : '' }}>Select</option>
                                            <option value="GOOD" {{ $blockcodes->condition == 'GOOD' ? 'selected' : '' }}>GOOD</option>
                                            <option value="AVERAGE" {{ $blockcodes->condition == 'AVERAGE' ? 'selected' : '' }}>AVERAGE</option>
                                            <option value="BAD" {{ $blockcodes->condition == 'BAD' ? 'selected' : '' }}>BAD</option>
                                    ...
                                    <!-- Male Voters -->
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label">Male Voters <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control @error('male_voters') is-invalid @enderror" id="male_voters" name="male_voters" value="{{ old('male_voters', $blockcodes->male_voters) }}" min="0" required>
                                        @error('male_voters')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>

                                    <!-- Female Voters -->
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label">Female Voters <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control @error('female_voters') is-invalid @enderror" id="female_voters" name="female_voters" value="{{ old('female_voters', $blockcodes->female_voters) }}" min="0" required>
                                        @error('female_voters')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>

                                    <!-- Total Voters -->
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label">Total Voters</label>
                                        <input type="number" class="form-control" id="total_voters" name="total_voters" value="{{ old('total_voters', $blockcodes->total_voters) }}" readonly>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-primary">Update Blockcode</button>
                                        <a href="{{ route('blockcode-information.index') }}" class="btn btn-secondary">Cancel</a>
                                    </div>
                                </div>
                            </form>
