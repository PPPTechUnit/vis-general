                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('blockcode') is-invalid @enderror"
                                               name="blockcode" value="{{ old('blockcode', $blockcodes->blockcode) }}" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('eloctoral_area_name') is-invalid @enderror"
                                               name="eloctoral_area_name" value="{{ old('eloctoral_area_name', $blockcodes->eloctoral_area_name) }}" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('village_city') is-invalid @enderror"
                                               name="village_city" value="{{ old('village_city', $blockcodes->village_city) }}" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('circle_name') is-invalid @enderror"
                                               name="circle_name" value="{{ old('circle_name', $blockcodes->circle_name) }}" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('committee') is-invalid @enderror"
                                               name="committee" value="{{ old('committee', $blockcodes->committee) }}" required>
                                    ...
                                    <!-- Provincial Assembly -->
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Select Assembly <span class="text-danger">*</span></label>
                                        <select class="form-control @error('provincial_constituency_name') is-invalid @enderror"
                                                name="provincial_constituency_name" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-control @error('division_name') is-invalid @enderror"
                                                id="division_name" name="division_name" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-control @error('district_name') is-invalid @enderror"
                                                id="district_name" name="district_name" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('book_number') is-invalid @enderror"
                                               name="book_number" value="{{ old('book_number', $blockcodes->book_number) }}" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('pages') is-invalid @enderror"
                                               name="pages" value="{{ old('pages', $blockcodes->pages) }}" min="1" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('missing_page') is-invalid @enderror"
                                               name="missing_page" value="{{ old('missing_page', $blockcodes->missing_page) }}">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('male_voters') is-invalid @enderror"
                                               id="male_voters" name="male_voters" value="{{ old('male_voters', $blockcodes->male_voters) }}" min="0" required>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('female_voters') is-invalid @enderror"
                                               id="female_voters" name="female_voters" value="{{ old('female_voters', $blockcodes->female_voters) }}" min="0" required>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control" id="total_voters" name="total_voters"
                                               value="{{ old('total_voters', $blockcodes->total_voters) }}" readonly>
