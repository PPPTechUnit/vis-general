...
@section('title', " :: User assigned blockcodes")
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="{{ route('blockcodes.index') }}" class="breadcrumb-item">User assigned blockcodes </a>
                                ...
                                <tbody>
                                  @foreach($blockcodes as $i=>$block)
                                    <tr>
                                        ...
                                        <td>{{isset($block['count_record'])?$block['count_record']:""}}</td>

                                        <td>
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">Action</button>
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a href="{{url('backend/blockcodes/view-records',$block['blockcode'])}}" class="dropdown-item"> View</a>
                                                    <a href="{{url('backend/blockcodes/edit-records',$block['blockcode'])}}" class="dropdown-item"> Edit</a>
                                                    <a href="{{url('backend/blockcodes/view-records/delete',$block['blockcode'])}}" onclick="return confirm('Are you sure you want to delete this ?');" class="dropdown-item"> Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
