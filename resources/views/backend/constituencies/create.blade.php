...
@section('title', " :: Add User's Constituencies")
...
@section('content')
    ...
    <div class="content">
        <div class="card">
            <div class="card-body">
                <form action="{{route('constituencies.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <fieldset class="mb-3">
                                    ...
                                    <div class="col-lg-12">
                                        <select  name="province" id="province" class="form-control">
                                            ...
                                            @foreach($provinces as $province)
                                                <option value="{{$province->id}}" @if($province->id == old('role')) selected @endif>{{$province->name}}</option>
                                            @endforeach
                                        </select>
