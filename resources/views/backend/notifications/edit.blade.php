 ...
 <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Notification</span> - Edit </h4>
    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('backend.notifications.update', $notification['id'])}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <fieldset class="mb-3">
                        <legend class="text-uppercase font-size-sm font-weight-bold">Edit Notification</legend>
                        @method('PATCH')
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="col-form-label col-lg-12">Message</label>
                                    <div class="col-lg-12">
