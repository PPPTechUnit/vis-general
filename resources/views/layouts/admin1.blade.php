...
<div class="navbar navbar-expand-md navbar-dark">
    <div class="navbar-brand">
        <a href="{{route('admin.dashboard')}}" class="d-inline-block">
            <img src="{{ asset('admin/assets/images/login-img.png')}}" alt="">
        </a>
    </div>
        ...
        <div class="sidebar-content">
            ...
            <div class="sidebar-user">
                <div class="card-body">
                    <div class="media">
                        <div class="mr-3">
                            <a href="{{route('admin.dashboard')}}"><img src="{{ asset('admin/assets/images/logo.png')}}" width="38" height="38" class="rounded-circle" alt=""></a>
                        </div>
            ...
            <div class="card card-sidebar-mobile">
                <ul class="nav nav-sidebar" data-nav-type="accordion">
                    ...
                    <li class="nav-item"><a href="{{route('admin.dashboard')}}" class="nav-link"><i class="icon-home4"></i><span>Dashboard</span></a></li>
                    <li class="nav-item"><a href="{{route('users.index')}}" class="nav-link"><i class="icon-users"></i><span>Users</span></a></li>
                    <li class="nav-item"><a href="{{route('blockcodes.index')}}" class="nav-link"><i class="icon-users"></i><span>blockcodes</span></a></li>
                    <li class="nav-item"><a href="{{url('admin/users-dashboard')}}" class="nav-link"><i class="icon-users"></i><span>Users Blockcode</span></a></li>
                </ul>
            </div>
        ...
        <div class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="navbar-collapse collapse" id="navbar-footer">
                <span class="navbar-text">
                    &copy; {{date('Y')}}. <a href="{{route('admin.dashboard')}}">PPP - Data Center</a>
                </span>
            </div>
        </div>
    </div>
