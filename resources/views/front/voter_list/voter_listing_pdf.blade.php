...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            <p class="text-center"><b>Blockcode Info</b># ({{$block_info['blockcode']}}), Total ({{$block_info['total_voters']}}),
                <b>Voterlist Info#</b>
                ...
                (Today# <span id="today_updated">{{$count_today}}</span> )</p>
        </div>
        <div class="col-lg-12" style="text-align: right">
            ...
            <button
                    ...
                    data-status="{{ $block_info['completed'] }}">
                {{ $block_info['completed'] == 1 ? 'Completed' : 'Pending' }}
            </button>
        </div>
            ...
            <div id="accordion">
                ...
                <div class="card">
                    ...
                    <div id="collapseOne" class="collapse show">
                        <div class="card-body">
                            <div>
                                <iframe src="{{ asset('blockcode_files/'.$block_info['blockcode'].'.pdf') }}#zoom=200" style="height:400px;width:100%;" title="PDF Preview"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
