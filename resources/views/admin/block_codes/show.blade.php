                        ...
                        <div class="table-responsive">
                            <table class="table  datatable-basic">
                                ...
                                @foreach($blockcodes as $key=> $code)
                                    <tr  class="code-clicktr"  id="blocktr-{{$code->blockcode}}" blockcode="{{$code->blockcode}}" >
                                        <td>{{$key+1}}</td>
                                        <td>
                                            <a href="{{url('admin/blockcodes/voters/'.$code->blockcode)}}" class=""> {{$code->blockcode}}</a>
                                        ...
                                        <td>
                                            <button
                                                    class="btn btn-sm status-btn {{ $code->tested == 1 ? 'btn-primary' : 'btn-danger' }}"
                                                    data-id="{{ $code->id }}"
                                                    data-status="{{ $code->tested }}">
                                                {{ $code->tested == 1 ? 'Tested' : 'Pending' }}
                                            </button>
                                        </td>
                                        <td>
                                            <button class="btn btn-sm  {{ $code->completed == 1 ? 'btn-success' : 'btn-warning' }}">
