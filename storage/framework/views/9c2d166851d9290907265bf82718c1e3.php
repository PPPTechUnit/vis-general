...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            <h3 class="text-center p-2"><b>VOTERLIST LISTING (<?php echo e($block_info['blockcode']); ?>)</b></h3>
            <h3 class="text-center p-2"><b>Total (<?php echo e($voters_count); ?>)</b></h3>
        </div>
        ...
        <div class="col-lg-12 blockcode-table-padding table-wrapper-scroll-y my-custom-scrollbar">
                ...
                <?php $__currentLoopData = $voters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $code): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr data-id="<?php echo e($code->id); ?>" data-blockcode="<?php echo e($code->blockcode); ?>">
                        ...
                        <td style="width: 28%; text-align: left;vertical-align: bottom;" class="voter-address">
                            <img src="<?php echo e(asset('blockcodes/'.$code->blockcode.'/'.$code->image_cnic.'_1.png')); ?>" style="width: 450px;"/><br>
                            <textarea class="form-control" name="address" rows="2"><?php echo e($code->address); ?></textarea>
                        </td>
                        
                        <td style="width: 5%;vertical-align: bottom" class="voter-age">
                            <img src="<?php echo e(asset('blockcodes/'.$code->blockcode.'/'.$code->image_cnic.'_2.png')); ?>" style="width: 40px;"/><br>
                            <input type="text"
                        ...
                        <td style="width: 12%; vertical-align: bottom;" class="voter-cnic">
                            <img src="<?php echo e(asset('blockcodes/'.$code->blockcode.'/'.$code->image_cnic.'_3.png')); ?>" style="width: 140px;"/><br>
                        ...
                        <td style="width: 12%; vertical-align: bottom;" class="voter-father">
                            <img src="<?php echo e(asset('blockcodes/'.$code->blockcode.'/'.$code->image_cnic.'_4.png')); ?>" style="width: 150px;"/><br>
                            <input type="text" class="form-control" name="father_husband_name" value="<?php echo e($code->father_husband_name); ?>" oninput="this.value = this.value.replace(/[^a-zA-Z ]/g, '')">
                        </td>
                        ...
                        <td style="width: 12%;vertical-align: bottom;" class="voter-name">
                            <img src="<?php echo e(asset('blockcodes/'.$code->blockcode.'/'.$code->cnic.'_5.png')); ?>" style="width: 150px;"/><br>
                            <input type="text" class="form-control" name="name" value="<?php echo e($code->name); ?>" oninput="this.value = this.value.replace(/[^a-zA-Z ]/g, '')">
                        </td>
                        
                        <td style="width: 5%;vertical-align: bottom;" class="voter-gharana">
                            <img src="<?php echo e(asset('blockcodes/'.$code->blockcode.'/'.$code->image_cnic.'_6.png')); ?>" style="width: 50px;"/><br>
                            <input type="text"
                                   class="form-control numeric-check"
                                   name="gharana_no"
                                   value="<?php echo e($code->gharana_no); ?>">                        </td>
                        
                        <td style="width: 5%;vertical-align: bottom;" class="voter-silsila">
                            <img src="<?php echo e(asset('blockcodes/'.$code->blockcode.'/'.$code->image_cnic.'_7.png')); ?>" style="width: 50px;"/><br>
                            <input type="text"
                                   class="form-control numeric-check"
                                   name="silsila_no"
                                   value="<?php echo e($code->silsila_no); ?>">                        </td>
            ...
            <?php echo $voters->links('vendor.pagination.bootstrap-4'); ?>
...
<?php echo $__env->make('layouts.front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\voterlist-system\resources\views/front/voter_list/voter_listing.blade.php ENDPATH**/ ?>