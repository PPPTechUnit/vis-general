                                ...
                                <tbody>
                                  <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i=>$user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('app-web-users.show',$user['id'])); ?>" > <?php echo e($user['name']); ?></a>
                                        ...
                                        <td><?php echo e($user['user_from']); ?></td>
                                        <td>
                                            <?php echo e(\Carbon\Carbon::parse($user['created_at'])->format('Y-m-d H:i:s')); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\vis-system-online\resources\views/backend/app_web_users/listing.blade.php ENDPATH**/ ?>