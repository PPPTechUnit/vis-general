...
<?php $__env->startSection('title', 'Blockcode Information  Edit Page'); ?>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="blockcodeForm" action="<?php echo e(route('blockcode-information.update', $blockcodes->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="blockcode" value="<?php echo e(old('blockcode', $blockcodes->blockcode)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" name="eloctoral_area_name" value="<?php echo e(old('eloctoral_area_name', $blockcodes->eloctoral_area_name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" name="village_city" value="<?php echo e(old('village_city', $blockcodes->village_city)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" name="circle_name" value="<?php echo e(old('circle_name', $blockcodes->circle_name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" name="committee" value="<?php echo e(old('committee', $blockcodes->committee)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" name="provincial_constituency_name" required>
                                            ...
                                            <?php $__currentLoopData = $nas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $na): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($na->id); ?>"
                                                        <?php echo e(old('provincial_constituency_name', $blockcodes->provincial_assembly_id) == $na->id ? 'selected' : ''); ?>>
                                                    <?php echo e($na->name); ?>
...
unset($__errorArgs, $__bag); ?>" id="division_name" name="division_name" required>
                                            ...
                                            <?php $__currentLoopData = $divisions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $division): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($division->id); ?>"
                                                        <?php echo e(old('division_name', $blockcodes->division_id) == $division->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" id="district_name" name="district_name" required>
                                            ...
                                            <?php $__currentLoopData = $districts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $district): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($district->id); ?>"
                                                        <?php echo e(old('district_name', $blockcodes->district_id) == $district->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" id="taluka_name" name="taluka_name" required>
                                            ...
                                            <?php $__currentLoopData = $tehsils; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tehsil): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($tehsil->id); ?>"
                                                        <?php echo e(old('taluka_name', $blockcodes->taluka_id) == $tehsil->id ? 'selected' : ''); ?>>
                                                    <?php echo e($tehsil->name); ?>
...
unset($__errorArgs, $__bag); ?>" name="book_number" value="<?php echo e(old('book_number', $blockcodes->book_number)); ?>" >
...
unset($__errorArgs, $__bag); ?>" name="pages" value="<?php echo e(old('pages', $blockcodes->pages)); ?>" >
...
unset($__errorArgs, $__bag); ?>" name="missing_page" value="<?php echo e(old('missing_page', $blockcodes->missing_page)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="condition" name="condition" required>
                                            <option value="" <?php echo e($blockcodes->condition == '' ? 'selected' : ''); ?>>Select</option>
                                            <option value="GOOD" <?php echo e($blockcodes->condition == 'GOOD' ? 'selected' : ''); ?>>GOOD</option>
                                            <option value="AVERAGE" <?php echo e($blockcodes->condition == 'AVERAGE' ? 'selected' : ''); ?>>AVERAGE</option>
                                            <option value="BAD" <?php echo e($blockcodes->condition == 'BAD' ? 'selected' : ''); ?>>BAD</option>
...
unset($__errorArgs, $__bag); ?>" id="male_voters" name="male_voters" value="<?php echo e(old('male_voters', $blockcodes->male_voters)); ?>" min="0" required>
...
unset($__errorArgs, $__bag); ?>" id="female_voters" name="female_voters" value="<?php echo e(old('female_voters', $blockcodes->female_voters)); ?>" min="0" required>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control" id="total_voters" name="total_voters" value="<?php echo e(old('total_voters', $blockcodes->total_voters)); ?>" readonly>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-12">
                                        ...
                                        <a href="<?php echo e(route('blockcode-information.index')); ?>" class="btn btn-secondary">Cancel</a>
                                    </div>
                                </div>
                            </form>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.verifier_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\vis-system-gb\resources\views/verifier/blockcode_information/edit.blade.php ENDPATH**/ ?>