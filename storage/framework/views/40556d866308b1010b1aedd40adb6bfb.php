...
<div class="navbar navbar-expand-md navbar-dark">
    <div class="navbar-brand">
        <a href="<?php echo e(route('backend_dashboard')); ?>" class="d-inline-block">
            <img src="<?php echo e(asset('admin/assets/images/login-img.png')); ?>" alt="" style="height: 35px;">
        </a>
    </div>
        ...
        <div class="sidebar-content">
            ...
            <div class="sidebar-user">
                <div class="card-body">
                    <div class="media">
                        <div class="mr-3">
                            <a href="<?php echo e(route('backend_dashboard')); ?>"><img src="<?php echo e(asset('admin/assets/images/logo.png')); ?>" width="38" height="38" class="rounded-circle" alt=""></a>
                        </div>
            ...
            <div class="card card-sidebar-mobile">
                ...
                ?>
                    ...
                    <li class="nav-item"><a href="<?php echo e(route('backend_dashboard')); ?>" class="nav-link <?php if(in_array( "dashboard" ,$full_url )): ?> active <?php endif; ?>"><i class="icon-home4"></i><span>Dashboard</span></a></li>
                        <li class="nav-item"><a href="<?php echo e(url('backend/ppp-users')); ?>" class="nav-link <?php if(in_array( "ppp-users" ,$full_url )): ?> active <?php endif; ?>"><i class="icon-users"></i><span>PPP Users</span></a></li>
                        <li class="nav-item"><a href="<?php echo e(route('app-web-users.index')); ?>" class="nav-link <?php if(in_array( "app-web-users" ,$full_url )): ?> active <?php endif; ?>"><i class="icon-users"></i><span>Polling Agents</span></a></li>
                        <li class="nav-item"><a href="<?php echo e(url('backend/searched-voters')); ?>" class="nav-link <?php if(in_array( "searched-voters" ,$full_url )): ?> active <?php endif; ?>"><i class="icon-users"></i><span>Searched Voters</span></a></li>
        ...
        <div class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="navbar-collapse collapse" id="navbar-footer">
                <span class="navbar-text">
                    &copy; <?php echo e(date('Y')); ?>. <a href="<?php echo e(route('backend_dashboard')); ?>">PPP - Data Center</a>
                </span>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\vis-system-online\resources\views/layouts/admin.blade.php ENDPATH**/ ?>